...
export default function TabVendor() {
  ...
  const { data: vendorList, isLoading: loadingData } = useGetPrincipals({
    type: searchParams.get('type') || 'vendor',
  ...
  }, [detail, detailAdmin, openDetailAdmin, setIdDetail]);
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between rounded-lg border bg-neutral-100 p-1.5">
        <div className="flex items-center">
          ...
          >
            ...
            {/* <Link href="/user-management/add-vendor">
              <ShopAdd size={16} />
              Add
            </Link> */}
          </Button>
      ...
      ) : vendorList && vendorList?.content?.length > 0 ? (
      ...
      <BasePagination
        totalCount={vendorList?.totalCount as number}
