...
type TDialogFollowUpProps = {
  open: boolean;
  setOpen: Dispatch<SetStateAction<boolean>>;
  onFollowUp: (payload: TRejectExchangePayload) => void;
  isLoading?: boolean;
};
...
export default function DialogFollowUp({
  open,
  setOpen,
  onFollowUp,
  isLoading,
}: TDialogFollowUpProps) {
            ...
            <div className=" w-full space-y-6 p-6">
              <div className="flex flex-col items-center justify-center gap-4">
                ...
                <div className=" space-y-1 text-center">
                  <p className=" font-medium text-neutral-800">Follow Up</p>
